# UNA MUESTRA T-TEST
set.seed(100) # creo una semilla cuando hacemos cosas con aleatoridad
x<-rnorm(50,mean=10,sd=0.5) # distribucion normal aleatoria
t.test(x,mu=10) # lo comparo si la media de mi muestra lo comparo con lo que nos deberia de salir
